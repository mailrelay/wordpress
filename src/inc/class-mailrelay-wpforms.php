...
class Mailrelay_WPForms {
    ...
    function settings_section_content( $instance ) {
        ...
        echo '<div class="wpforms-panel-content-section wpforms-panel-content-section-mailrelay">';
        echo '<div class="wpforms-panel-content-section-title">' . __( 'Mailrelay', 'mailrelay' ) . '</div>';
		...
		$mailrelay_fields = array("email" => "Email Address", "name" => "Name", "address" => "Address", "city" => "City", "state" => "State", "country" => "Country", "birthday" => "Birthday", "website" => "Website", "time_zone" => "Time Zone"); //TODO: save this list in plugin configuration
    ...
    function send_data_to_mailrelay( $fields, $entry, $form_data, $entry_id ) {

		$mailrelay_fields = array("email" => "Email Address", "name" => "Name", "address" => "Address", "city" => "City", "state" => "State", "country" => "Country", "birthday" => "Birthday", "website" => "Website", "time_zone" => "Time Zone");
		...
		if(!array_key_exists("email", $args)) return;
